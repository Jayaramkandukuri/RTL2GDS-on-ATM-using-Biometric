...
//***************************************************************************//
//                                                                           //
//  FILE CREATED..............November 22, 2024 at 19:31:58                  //
//                                                                           //
...
//***************************************************************************//
  ...
  module Project_05_FULLSCAN_logic ;
...
//***************************************************************************//
  ...
  ATM
    ATM_inst (
      .clk                     ( part_PIs[12] ),      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
      .reset                   ( part_PIs[22] ),      // pinName = reset;  tf = -SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
      .pin_input               ({part_PIs[21]  ,      // pinName = pin_input[3]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[20]  ,      // pinName = pin_input[2]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[19]  ,      // pinName = pin_input[1]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[18]}),      // pinName = pin_input[0]; testOffset = 0.000000;  scanOffset = 0.000000;  
      .amount_input            ({part_PIs[09]  ,      // pinName = amount_input[7]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[08]  ,      // pinName = amount_input[6]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[07]  ,      // pinName = amount_input[5]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[06]  ,      // pinName = amount_input[4]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[05]  ,      // pinName = amount_input[3]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[04]  ,      // pinName = amount_input[2]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[03]  ,      // pinName = amount_input[1]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[02]}),      // pinName = amount_input[0]; testOffset = 0.000000;  scanOffset = 0.000000;  
      .biometric_authenticated ( part_PIs[10] ),      // pinName = biometric_authenticated; testOffset = 0.000000;  scanOffset = 0.000000;  
      .change_pin_request      ( part_PIs[11] ),      // pinName = change_pin_request; testOffset = 0.000000;  scanOffset = 0.000000;  
      .new_pin                 ({part_PIs[17]  ,      // pinName = new_pin[3]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[16]  ,      // pinName = new_pin[2]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[15]  ,      // pinName = new_pin[1]; testOffset = 0.000000;  scanOffset = 0.000000;  
                                 part_PIs[14]}),      // pinName = new_pin[0]; testOffset = 0.000000;  scanOffset = 0.000000;  
      .inactivity_timeout      ( part_PIs[13] ),      // pinName = inactivity_timeout; testOffset = 0.000000;  scanOffset = 0.000000;  
      .transaction_success     ( part_POs[06] ),      // pinName = transaction_success; 
      .transaction_error       ( part_POs[05] ),      // pinName = transaction_error; 
      .pin_change_success      ( part_POs[02] ),      // pinName = pin_change_success; 
      .account_locked          ( part_POs[01] ),      // pinName = account_locked; 
      .timeout_error           ( part_POs[04] ),      // pinName = timeout_error; 
      .SE                      ( part_PIs[01] ),      // pinName = SE;  tf = +SE  ; testOffset = 0.000000;  scanOffset = 0.000000;  
      .scan_in                 ( part_PIs[23] ),      // pinName = scan_in;  tf =  SI  ; testOffset = 0.000000;  scanOffset = 0.000000;  
      .scan_out                ( part_POs[03] )     // pinName = scan_out;  tf =  SO  ; 
      );
...
//***************************************************************************//
  ...
  assign ( weak0, weak1 ) // Termination 
    part_POs [1] = global_term,     // pinName = account_locked; 
    part_POs [2] = global_term,     // pinName = pin_change_success; 
    part_POs [3] = global_term,     // pinName = scan_out;  tf =  SO  ; 
    part_POs [4] = global_term,     // pinName = timeout_error; 
    part_POs [5] = global_term,     // pinName = transaction_error; 
    part_POs [6] = global_term;      // pinName = transaction_success; 
...
//***************************************************************************//
  ...
  initial 
    begin 
      ...
      `ifdef sdf_annotate 
        `ifdef SDF_Minimum 
          $sdf_annotate ("default.sdf",ATM_inst,,"sdf_Min.log","MINIMUM");
        `endif 
        `ifdef SDF_Maximum 
          $sdf_annotate ("default.sdf",ATM_inst,,"sdf_Max.log","MAXIMUM");
        `endif 
        `ifdef SDF_Typical
          $sdf_annotate ("default.sdf",ATM_inst,,"sdf_Typ.log","TYPICAL");
        `endif 
      `endif 
      ...
      if ( $test$plusargs ( "vcd" ) )  begin 
        $dumpfile("out.vcd"); 
        $dumpvars(0,Project_05_FULLSCAN_logic ); 
      end  
...
//***************************************************************************//
  ...
  task sim_setup; 
    begin 
      ...
      SERIALCYCLE = 0; 
      SEQNUM = 0; 
      name_POs [1] = "account_locked";      // pinName = account_locked; 
      name_POs [2] = "pin_change_success";      // pinName = pin_change_success; 
      name_POs [3] = "scan_out";      // pinName = scan_out;  tf =  SO  ; 
      name_POs [4] = "timeout_error";      // pinName = timeout_error; 
      name_POs [5] = "transaction_error";      // pinName = transaction_error; 
      name_POs [6] = "transaction_success";      // pinName = transaction_success; 
      ...
      stim_PIs = {23{1'bX}};   
      stim_CIs = 23'bXXXXXXXXXXX0XXXXXXXXX0X; 
      meas_POs = {6{1'bX}};   
      stim_CR_1 = {13{1'b0}};   
      meas_OR_1 = {13{1'bX}};   
...
//***************************************************************************//
  ...
  task sim_vector_file; 
    begin 
      ...
      $display ( "\nINFO (TVE-189): Design:  ATM   Test Mode:  FULLSCAN   InExperiment:  logic " ); 
  ...
  task test_cycle; 
    begin 
     ...
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
      ...
      part_PIs [2] = stim_PIs [2];      // pinName = amount_input[0]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [3] = stim_PIs [3];      // pinName = amount_input[1]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [4] = stim_PIs [4];      // pinName = amount_input[2]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [5] = stim_PIs [5];      // pinName = amount_input[3]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [6] = stim_PIs [6];      // pinName = amount_input[4]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [7] = stim_PIs [7];      // pinName = amount_input[5]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [8] = stim_PIs [8];      // pinName = amount_input[6]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [9] = stim_PIs [9];      // pinName = amount_input[7]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [10] = stim_PIs [10];      // pinName = biometric_authenticated; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [11] = stim_PIs [11];      // pinName = change_pin_request; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [13] = stim_PIs [13];      // pinName = inactivity_timeout; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [14] = stim_PIs [14];      // pinName = new_pin[0]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [15] = stim_PIs [15];      // pinName = new_pin[1]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [16] = stim_PIs [16];      // pinName = new_pin[2]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [17] = stim_PIs [17];      // pinName = new_pin[3]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [18] = stim_PIs [18];      // pinName = pin_input[0]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [19] = stim_PIs [19];      // pinName = pin_input[1]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [20] = stim_PIs [20];      // pinName = pin_input[2]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [21] = stim_PIs [21];      // pinName = pin_input[3]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [23] = stim_PIs [23];      // pinName = scan_in;  tf =  SI  ; testOffset = 0.000000;  scanOffset = 0.000000;  
     #8.000000;        // 8.000000 ns;  From the start of the cycle.
      part_PIs [12] = stim_PIs [12];      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
      part_PIs [22] = stim_PIs [22];      // pinName = reset;  tf = -SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
     #8.000000;        // 16.000000 ns;  From the start of the cycle.
      part_PIs [12] = stim_CIs [12];      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
      part_PIs [22] = stim_CIs [22];      // pinName = reset;  tf = -SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
     #56.000000;        // 72.000000 ns;  From the start of the cycle.
      ...
      for ( POnum = 1; POnum <= 6; POnum = POnum + 1 ) begin 
        if (( part_POs [ POnum ] !== meas_POs [ POnum ] ) & ( meas_POs [ POnum ] !== 1'bX )) begin 
          ...
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "ATM", name_POs [ POnum ], PATTERN, -1, part_POs [ POnum ] ); 
          end  
        end  
  ...
  task Scan_Sequence_TM_1_SEQ_2_SOP_1; 
    begin 
      ...
      for ( SCANCYCLE = 1; SCANCYCLE <= MAX; SCANCYCLE = SCANCYCLE + 1 ) begin 
        ...
        SERIALCYCLE = SERIALCYCLE + 1; 
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
        part_PIs [23] = stim_CR_1 [ 0 + SCANCYCLE ];      // pinName = scan_in;  tf =  SI  ; testOffset = 0.000000;  scanOffset = 0.000000;  
     #8.000000;        // 8.000000 ns;  From the start of the cycle.

        if (( part_POs [3] !== meas_OR_1 [ 0 + SCANCYCLE ] ) & ( meas_OR_1 [ 0 + SCANCYCLE ] !== 1'bX )) begin      // pinName = scan_out;  tf =  SO  ; 
          if ( test_num != failed_test_num )  begin 
            num_failed_tests = num_failed_tests + 1; 
            failed_test_num = test_num; 
          end  
          ...
          $display ( "           Expected: %0b   Simulated: %0b   Observe Register (OR) = 1;   Measured on Scan Cycle: %0d   Measured at SO: %0s   ", meas_OR_1 [ 0 + SCANCYCLE ], part_POs [3], SCANCYCLE, name_POs [3] ); 

          if (( failset ) & ( FAILSETID == 0 ))  failset_setup; 
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "ATM", name_POs [3], PATTERN, SCANCYCLE, part_POs [3] ); 
          end  
        end  
        else  begin 
     ...
     #8.000000;        // 16.000000 ns;  From the start of the cycle.
        part_PIs [12] = 1'b1;      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
     #8.000000;        // 24.000000 ns;  From the start of the cycle.
        part_PIs [12] = 1'b0;      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
  ...
  task cmd_code; 
    begin 
      ...
      case ( CMD ) 
        ...
        200: begin 
          if ( rc_read > 0 )  begin 
            rc_read = $fscanf ( DATAID, "%b", stim_PIs [1:23] ); 
            if ( rc_read <= 0 )  bad_cmd_code; 
            line_number = line_number + 1; 
          end  
        end  
        ...
        201: begin 
          if ( rc_read > 0 )  begin 
            rc_read = $fscanf ( DATAID, "%b", stim_CIs [1:23] ); 
            if ( rc_read <= 0 )  bad_cmd_code; 
            line_number = line_number + 1; 
          end  
        end  
                ...
                if ( rc_read <= 0 )  bad_cmd_code; 
                  ...
                  case ( SCANNUM ) 
                    ...
                    1: begin 
                      ...
                      if ( rc_read > 0 )  begin 
                        rc_read = $fscanf ( DATAID, "%b", stim_CR_1 [1:13] ); 
                        if ( rc_read <= 0 )  bad_cmd_code; 
                        line_number = line_number + 1; 
                      end  
                    end  
                ...
                if ( rc_read <= 0 )  bad_cmd_code; 
                  ...
                  case ( SCANNUM ) 
                    ...
                    1: begin 
                      ...
                      if ( rc_read > 0 )  begin 
                        rc_read = $fscanf ( DATAID, "%b", meas_OR_1 [1:13] ); 
                        if ( rc_read <= 0 )  bad_cmd_code; 
                        line_number = line_number + 1; 
                      end  
                    end  
        ...
        904: begin 
          ...
          if ( rc_read > 0 )  begin 
            `ifdef MISCOMPAREDEBUG 
              if ( diag_debug ) begin 
                $processSimulationDebugFile ( DIAG_DEBUG_FILE, "ATM_inst", eventID ); 
              end 
            `endif 
          end  
          else  bad_cmd_code; 
