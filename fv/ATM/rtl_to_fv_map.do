...
# Generated on: Fri Nov 22 19:33:46 IST 2024 (Fri Nov 22 14:03:46 UTC 2024)
...
set_log_file fv/ATM/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/ATM -revised fv_map
...
add_search_path /home/installs/FOUNDRY/digital/90nm/dig/lib -library -both
read_library -liberty -both /home/installs/FOUNDRY/digital/90nm/dig/lib/slow.lib
...
add_search_path /home/cadence/Documents/Project_05 -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/cadence/Documents/Project_05/ATM.v
elaborate_design -golden -root {ATM} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/ATM/fv_map.v.gz
elaborate_design -revised -root {ATM}
...
#add_name_alias fv/ATM/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/ATM/rtl_to_fv_map.log
}
