...
build_model \
    -cell	 ATM \
    -techlib	 slow.v \
    -designsource	 $WORKDIR/ATM.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/ATM.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
check_log log_create_logic_tests_FULLSCAN_ATM_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 ATM_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_ATM_atpg
...
check_log log_commit_tests_FULLSCAN_ATM_atpg
